...
public interface Graph<V, E> {
    ...
    /**
     * Returns the number of edges leaving vertex v. Note that for an undirected graph, this is the same
     * result returned by inDegree
     *
    ...
    /**
     * Returns the number of edges for which vertex v is the destination. Note that for an undirected
     * graph, this is the same result returned by outDegree
     *
     * @throws IllegalArgumentException if v is not a valid vertex
     */
    ...
    /**
     * Returns an iterable collection of edges for which vertex v is the origin. Note that for an
     * undirected graph, this is the same result returned by incomingEdges.
     *
     * @throws IllegalArgumentException if v is not a valid vertex
     */
    ...
    /**
     * Returns an iterable collection of edges for which vertex v is the destination. Note that for an
     * undirected graph, this is the same result returned by outgoingEdges.
     *
     * @throws IllegalArgumentException if v is not a valid vertex
     */
    ...
    /**
     * Returns the vertices of edge e as an array of length two. If the graph is directed, the first
     * vertex is the origin, and the second is the destination. If the graph is undirected, the order is
     * arbitrary.
     */
